      ...
      {auth &&
        <FormContainer>
          ...
          <Form onSubmit={submitHandler}>
            ...
            <Button disabled={isButtonDisabled} onClick={handleButtonClick} variant='outline-primary' className='w-100 mt-3 py-3'>
              {isButtonDisabled ? `Wait ${timer} seconds` : 'Resend Verification Code'}
            </Button>
          </Form>
        </FormContainer>
      }
